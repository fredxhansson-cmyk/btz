...
export function StudioProvider({ children }) {
  ...
  const value = useMemo(() => ({
    ...
    play, stop, pause, togglePlay, setMode, newProject, loadTemplate, addToArrangement, saveFile, openFile, exportWav, exportAudio, loadSampleFile, separateStemsFile, decodeUrlAudio, addBufferChannel, dropAudioOnTimeline,
