...
export const SCALES = [
  ...
  { id: 'melodic', name: 'Melodic minor', steps: [0, 2, 3, 5, 7, 9, 11] },
  ...
  { id: 'pentaMajor', name: 'Major pentatonic', steps: [0, 2, 4, 7, 9] },
  { id: 'pentaMinor', name: 'Minor pentatonic', steps: [0, 3, 5, 7, 10] },
