...
export const MASTER_PRESETS = [
  {
    ...
    name: 'Rent',
    target: -16,
    desc: 'Ingen bearbetning alls. Bra nar du fortfarande bygger latten.',
    chain: [],
  },
  {
    id: 'streaming',
    name: 'Streaming −14',
    target: -14,
    desc: 'Balanserad kedja for Spotify, YouTube och liknande.',
    chain: [
  ...
  },
  {
    ...
    name: 'Klubb −9',
    target: -9,
    desc: 'Hardare limiting och lite mattnad for hog niva pa anlaggning.',
    chain: [
  ...
  },
  {
    ...
    name: 'Tape / varm',
    target: -13,
    desc: 'Mjuk mattnad, dampad diskant och lite limmande kompression.',
    chain: [
  ...
  },
  {
    ...
    name: 'Bred & luftig',
    target: -14,
    desc: 'Bredare stereobild med mono i basen och lyft i diskanten.',
    chain: [
  ...
  },
  {
    ...
    name: 'Podcast / rost',
    target: -16,
    desc: 'Smalt fokus, tydlig mellanregister och jamn niva.',
    chain: [
