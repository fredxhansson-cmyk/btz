...
export const SAMPLE_SOUNDS = [
  ...
  SMP('smpp_conga', 'Conga', 'Perc', '/samples/world/conga.wav', ['perc', 'latin', 'world', 'real']),
  SMP('smpp_bongohi', 'Bongo Hi', 'Perc', '/samples/world/bongo-hi.wav', ['perc', 'latin', 'world', 'real']),
  SMP('smpp_bongolo', 'Bongo Lo', 'Perc', '/samples/world/bongo-lo.wav', ['perc', 'latin', 'world', 'real']),
  SMP('smpp_darbuka', 'Darbuka', 'Perc', '/samples/world/darbuka.wav', ['perc', 'world', 'real']),
  SMP('smpp_frame', 'Frame Drum', 'Perc', '/samples/world/framedrum.wav', ['perc', 'world', 'real']),
  // Acoustic kit (VCSL, CC0).
  SMP('smpk_acoustic', 'Acoustic Kick', 'Kick', '/samples/acoustic/kick-ac.wav', ['acoustic', 'live', 'real']),
  SMP('smps_acoustic', 'Acoustic Snare', 'Snare', '/samples/acoustic/snare-ac.wav', ['acoustic', 'live', 'real']),
  ...
  SMPZ('smp_organ', 'Pipe Organ', 'Keys', [
    { url: '/samples/keys/organ-c3.wav', root: 48 },
    { url: '/samples/keys/organ-c4.wav', root: 60 },
    { url: '/samples/keys/organ-c5.wav', root: 72 },
  ], '/samples/keys/organ-c4.wav', ['organ', 'keys', 'gospel', 'real'], { release: 0.2, decay: 4, sustain: 1 }),
  SMPZ('smp_harpsi', 'Harpsichord', 'Keys', [
    { url: '/samples/keys/harpsi-c3.wav', root: 48 },
    { url: '/samples/keys/harpsi-c4.wav', root: 60 },
    { url: '/samples/keys/harpsi-c5.wav', root: 72 },
  ], '/samples/keys/harpsi-c4.wav', ['harpsichord', 'keys', 'baroque', 'real'], { release: 0.25, decay: 4, sustain: 1 }),
  SMPZ('smp_sax', 'Tenor Saxophone', 'Lead', [
    { url: '/samples/winds/sax-c3.wav', root: 48 },
    { url: '/samples/winds/sax-c4.wav', root: 60 },
  ], '/samples/winds/sax-c4.wav', ['sax', 'wind', 'jazz', 'soul', 'real'], { release: 0.2, decay: 4, sustain: 1 }),
  SMPZ('smp_guitar', 'Acoustic Guitar', 'Guitar', [
    { url: '/samples/guitar/guitar-c3.wav', root: 48 },
    { url: '/samples/guitar/guitar-c4.wav', root: 60 },
    { url: '/samples/guitar/guitar-c5.wav', root: 72 },
  ], '/samples/guitar/guitar-c4.wav', ['guitar', 'acoustic', 'real'], { release: 0.3, decay: 4, sustain: 1 }),
