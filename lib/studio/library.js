...
export const DRUM_SOUNDS = [
  ...
  D('kacoustic', 'Akustisk Kick', 'Kick', 'kick', { tune: 62, punch: 5, pitchDecay: 0.02, decay: 0.3, click: 0.6, drive: 0.08 }, ['live', 'rock']),
  ...
  D('sacoustic', 'Akustisk Snare', 'Snare', 'snare', { tune: 195, tone: 0.45, decay: 0.36, snap: 2100, width: 1, drive: 0.05 }, ['live']),
  ...
  D('ptamb', 'Tamburin', 'Perc', 'perc', { tune: 2600, ratio: 2.2, decay: 0.1, noise: 0.85 }, ['organic']),
  ...
  // toms
  D('tlow', 'Låg Tom', 'Tom', 'tom', { tune: 90, bend: 1.6, decay: 0.5, noise: 0.1 }, ['808']),
  D('tmid', 'Mellan Tom', 'Tom', 'tom', { tune: 140, bend: 1.6, decay: 0.42, noise: 0.1 }, ['808']),
  D('thigh', 'Hög Tom', 'Tom', 'tom', { tune: 205, bend: 1.6, decay: 0.35, noise: 0.1 }, ['808']),
  ...
  D('cyrev', 'Kort Splash', 'Cymbal', 'hat', { tune: 44, hpf: 7200, decay: 0.45, metal: 1 }, ['edm']),
];
...
export const INST_SOUNDS = [
  // bass
  M('bsub', 'Sub Bass', 'Bas', 'osc3', { wave1: 'sine', lvl1: 1, wave2: 'sine', coarse2: -12, lvl2: 0.5, lvl3: 0, cutoff: 400, res: 1, envAmt: 0.5, fdecay: 0.2, attack: 0.005, decay: 0.3, sustain: 0.9, release: 0.15, drive: 0.1 }, ['trap', '808']),
  M('bsaw', 'Saw Bass', 'Bas', 'osc3', { wave1: 'sawtooth', wave2: 'square', lvl2: 0.4, coarse3: -12, lvl3: 0.6, cutoff: 620, res: 6, envAmt: 2.2, fdecay: 0.22, sustain: 0.5, release: 0.12, drive: 0.25 }, ['house', 'techno']),
  M('bacid', 'Acid Line', 'Bas', 'osc3', { wave1: 'sawtooth', lvl1: 1, lvl2: 0, lvl3: 0, cutoff: 280, res: 18, envAmt: 3.4, fdecay: 0.16, attack: 0.002, decay: 0.14, sustain: 0.2, release: 0.08, drive: 0.5 }, ['acid', 'techno']),
  M('breese', 'Reese', 'Bas', 'osc3', { wave1: 'sawtooth', wave2: 'sawtooth', fine2: 22, lvl2: 1, wave3: 'sawtooth', fine3: -19, lvl3: 1, cutoff: 700, res: 4, envAmt: 1, fdecay: 0.5, sustain: 0.9, release: 0.2, drive: 0.3 }, ['dnb', 'dubstep']),
  M('bfm', 'FM Bass', 'Bas', 'fm', { ratio: 1, index: 6, idecay: 0.18, attack: 0.002, decay: 0.25, sustain: 0.5, release: 0.12, cutoff: 3000 }, ['funk']),
  M('bpluckb', 'Pluck Bass', 'Bas', 'pluck', { wave: 'sawtooth', spread: 4, sub: 0.7, cutoff: 900, res: 8, envAmt: 2.4, decay: 0.5, body: 0.15 }, ['house']),
  M('bgrowl', 'Growl', 'Bas', 'fm', { ratio: 2.5, index: 14, idecay: 0.5, attack: 0.01, decay: 0.6, sustain: 0.7, release: 0.2, cutoff: 2400 }, ['dubstep']),
  M('bwarm', 'Varm Analog', 'Bas', 'osc3', { wave1: 'triangle', wave2: 'sawtooth', lvl2: 0.55, coarse3: -12, lvl3: 0.35, cutoff: 520, res: 2, envAmt: 1.2, fdecay: 0.4, attack: 0.01, decay: 0.4, sustain: 0.7, release: 0.25, drive: 0.12 }, ['lofi']),
  ...
  M('lflute', 'Mjuk Flöjt', 'Lead', 'osc3', { wave1: 'sine', lvl1: 1, wave2: 'triangle', lvl2: 0.3, lvl3: 0, cutoff: 3200, res: 1, envAmt: 0.6, fdecay: 0.5, attack: 0.08, decay: 0.4, sustain: 0.85, release: 0.35 }, ['ambient']),
  ...
  // pads
  M('pwarm', 'Varm Pad', 'Pad', 'osc3', { wave1: 'sawtooth', wave2: 'sawtooth', fine2: 9, lvl2: 0.8, wave3: 'triangle', coarse3: -12, lvl3: 0.6, cutoff: 1800, res: 1, envAmt: 1, fdecay: 1.6, attack: 0.6, decay: 1.2, sustain: 0.85, release: 1.4 }, ['ambient']),
  M('pglass', 'Glaspad', 'Pad', 'fm', { ratio: 2, index: 2.5, idecay: 1.6, attack: 0.5, decay: 1.6, sustain: 0.7, release: 1.6, cutoff: 8000 }, ['ambient']),
  M('pstring', 'Stråkar', 'Pad', 'osc3', { wave1: 'sawtooth', wave2: 'sawtooth', fine2: 6, lvl2: 0.9, wave3: 'sawtooth', fine3: -6, lvl3: 0.9, cutoff: 2600, res: 1.5, envAmt: 0.8, fdecay: 1.2, attack: 0.35, decay: 1, sustain: 0.9, release: 0.9 }, ['cinematic']),
  M('pchoir', 'Kör', 'Pad', 'osc3', { wave1: 'triangle', wave2: 'sine', coarse2: 12, lvl2: 0.5, wave3: 'triangle', fine3: 12, lvl3: 0.7, cutoff: 2200, res: 1, envAmt: 0.5, fdecay: 1.5, attack: 0.5, decay: 1.5, sustain: 0.9, release: 1.6 }, ['cinematic']),
  M('pdark', 'Mörk Drone', 'Pad', 'osc3', { wave1: 'sawtooth', coarse1: -12, lvl1: 1, wave2: 'square', coarse2: -12, fine2: 11, lvl2: 0.6, lvl3: 0.4, coarse3: -24, cutoff: 700, res: 3, envAmt: 0.6, fdecay: 2.5, attack: 1.2, decay: 2, sustain: 0.9, release: 2.5 }, ['ambient', 'horror']),
  ...
  M('korgan', 'Orgel', 'Keys', 'osc3', { wave1: 'sine', lvl1: 1, wave2: 'sine', coarse2: 12, lvl2: 0.7, wave3: 'sine', coarse3: 19, lvl3: 0.45, cutoff: 6000, res: 0.5, envAmt: 0, fdecay: 0.1, attack: 0.01, decay: 0.1, sustain: 1, release: 0.15 }, ['soul', 'house']),
  ...
  M('kharp', 'Harpa', 'Keys', 'pluck', { wave: 'triangle', spread: 6, sub: 0.15, cutoff: 4800, res: 3, envAmt: 1.8, decay: 1.6, body: 0.5 }, ['cinematic']),
  M('kguitar', 'Nylonsträng', 'Keys', 'pluck', { wave: 'sawtooth', spread: 8, sub: 0.25, cutoff: 2400, res: 5, envAmt: 2.2, decay: 1.2, body: 0.4 }, ['organic', 'lofi']),
  ...
  M('fxnoise', 'Brusvåg', 'FX', 'snare', { tune: 120, tone: 0, decay: 1.2, snap: 4000, width: 0.4, drive: 0.2 }, ['edm', 'transition']),
];

export const LIBRARY = [...DRUM_SOUNDS, ...INST_SOUNDS];

export const DRUM_CATS = ['Kick', 'Snare', 'Clap', 'Hihat', 'Perc', 'Tom', 'Cymbal'];
export const INST_CATS = ['Bas', 'Lead', 'Pad', 'Keys', 'FX'];
...
export const soundColor = (sound, index = 0) => {
  const map = {
    ...
    Bas: 6, Lead: 8, Pad: 7, Keys: 11, FX: 9,
  };
