...
export const SAMPLE_SOUNDS = [
  ...
  // Melodic instruments (VCSL, CC0) — real recorded keys. Root note C4 = key 60.
  SMP('smp_ep', 'Electric Piano (Rhodes)', 'Keys', '/samples/keys/ep-c4.wav', ['rhodes', 'ep', 'keys', 'real'], { release: 0.35, decay: 4, sustain: 1 }),
  SMP('smp_piano', 'Grand Piano', 'Keys', '/samples/keys/piano-c4.wav', ['piano', 'keys', 'real'], { release: 0.3, decay: 4, sustain: 1 }),
];
