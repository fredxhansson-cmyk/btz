...
export const KITS = [
  {
    id: 'tr808',
    name: 'FLOW-808',
    desc: 'Deep sub kick, thin snare, metallic hi-hats.',
    pads: {
  ...
  },
  {
    id: 'tr909',
    name: 'FLOW-909',
    desc: 'Punchy kick with click, noisy snare, bright hats.',
    pads: {
  ...
  },
  {
    id: 'acoustic',
    name: 'FLOW Acoustic',
    desc: 'Softer, shorter and more like a real drum kit.',
    pads: {
  ...
  },
  {
    id: 'trap',
    name: 'FLOW Trap',
    desc: 'Long 808 kick, sharp claps and fast hats.',
    pads: {
  ...
  },
  {
    id: 'lofi',
    name: 'FLOW LoFi',
    desc: 'Dark, muffled and a little out of tune.',
    pads: {
  ...
  },
  {
    id: 'techno',
    name: 'FLOW Techno',
    desc: 'Hard kick, short metallic hats, industrial percussion.',
    pads: {
      kick: 'ktechno', snare: 'snoise', clap: 'ctight', rim: 'pwood',
      chat: 'htrap', ohat: 'h909o', shaker: 'hshaker', tamb: 'pclave',
      tomlo: 'tlow', tommid: 'tmid', tomhi: 'thigh', cym: 'cyrev',
    },
  },
  {
    id: 'boombap',
    name: 'FLOW Boom Bap',
    desc: 'Muffled kick, fat backbeat and room reverb — 90s.',
    pads: {
      kick: 'klofi', snare: 'sfat', clap: 'croom', rim: 'prim',
      chat: 'hlofi', ohat: 'hopen', shaker: 'hshaker', tamb: 'ptamb',
      tomlo: 'tfloor', tommid: 'tmid', tomhi: 'thigh', cym: 'cyride',
    },
  },
  {
    id: 'edm',
    name: 'FLOW EDM',
    desc: 'Big kick, wide clap and bright hats for the club.',
    pads: {
      kick: 'k909', snare: 's909', clap: 'cwide', rim: 'pclave',
      chat: 'h909c', ohat: 'h909o', shaker: 'hshaker', tamb: 'ptamb',
      tomlo: 'tlow', tommid: 'tmid', tomhi: 'thigh', cym: 'cycrash',
    },
  },
  {
    id: 'minimal',
    name: 'FLOW Minimal',
    desc: 'Clicky kick, dry hits, almost no reverb.',
    pads: {
      kick: 'kclick', snare: 'srim', clap: 'ctight', rim: 'pwood',
      chat: 'htrap', ohat: 'h909o', shaker: 'hshaker', tamb: 'pclave',
      tomlo: 'tlow', tommid: 'tmid', tomhi: 'thigh', cym: 'cyrev',
    },
  },
  {
    id: 'organic',
    name: 'FLOW Organic',
    desc: 'Acoustic drum kit with congas, shaker and tambourine.',
    pads: {
      kick: 'kacoustic', snare: 'sacoustic', clap: 'croom', rim: 'pwood',
      chat: 'hshaker', ohat: 'hopen', shaker: 'hshaker', tamb: 'ptamb',
      tomlo: 'pconga', tommid: 'pbongo', tomhi: 'thigh', cym: 'cyride',
    },
  },
];

/**
 * Resolves a kit pad to {inst, params, color}. Pads are either written inline
 * as [inst, params, colorIndex] or reference a sound from the FLOW library.
 */
export function padSpec(kit, role) {
  const raw = kit && kit.pads ? kit.pads[role] : null;
  if (!raw) return null;
  if (typeof raw === 'string') {
    const sound = soundById(raw);
    if (!sound) return null;
    return { inst: sound.inst, params: sound.params, color: null, sound: raw };
  }
  return { inst: raw[0], params: raw[1], color: COLORS[raw[2] % COLORS.length], sound: null };
}
...
/** Chance that a role plays on a given 16th step — used by "Randomize". */
const DENSITY = {
