...
export const KITS = [
  ...
  },
  {
    id: 'techno',
    name: 'FLOW Techno',
    desc: 'Hard kick, korta metalliska hats, industriell perkussion.',
    pads: {
  ...
  },
  {
    id: 'boombap',
    name: 'FLOW Boom Bap',
    desc: 'Dov kick, fet backbeat och rumsklang — 90-tal.',
    pads: {
  ...
  },
  {
    id: 'edm',
    name: 'FLOW EDM',
    desc: 'Stor kick, bred clap och ljusa hats for klubb.',
    pads: {
  ...
  },
  {
    id: 'minimal',
    name: 'FLOW Minimal',
    desc: 'Klickig kick, torra traffar, nastan inget efterklang.',
    pads: {
  ...
  },
  {
    id: 'organic',
    name: 'FLOW Organic',
    desc: 'Akustiskt trumset med congas, shaker och tamburin.',
    pads: {
