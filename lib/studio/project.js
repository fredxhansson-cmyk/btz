...
import { masterPreset } from './mastering';
...
export function makeChannel(inst, name, opts = {}) {
  return {
    ...
    // Optional multisample zones: [{ sampleId, root }]. When present the sampler
    // picks the zone whose recorded root is nearest the played note, so pitched
    // instruments stay natural across the whole keyboard instead of one stretched
    // sample. `sampleId` above stays as a single-zone fallback.
...
export function createDefaultProject() {
  ...
  return {
    ...
    loopEnd: 0,
    countIn: 0,
    master: { vol: 0.75, chain: [], preset: 'clean', target: -14 },
    channels,
    patterns,
    inserts,
    playlist,
...
export function normalizeProject(raw) {
  ...
  p.master = { vol: 0.75, chain: [], preset: 'clean', target: -14, ...(raw.master || {}) };
  p.master.chain = Array.isArray(p.master.chain) ? p.master.chain : [];
...
export const TEMPLATES = [
  {
    ...
    swing: 0,
    master: 'club',
    drums: { kick: [0, 4, 8, 12], chat: [2, 6, 10, 14], ohat: [6, 14], clap: [4, 12], rim: [7, 15] },
  ...
  },
  {
    ...
    drums: {
      kick: [0, 10, 16, 26],
      snare: [8, 24],
      chat: [2, 6, 10, 14, 18, 22, 26, 30],
      ohat: [7, 23],
      rim: [13, 29],
    },
    bass: [[0, 29], [8, 29], [16, 27], [24, 32]],
    chords: [[0, [53, 56, 60, 63]], [16, [51, 55, 58, 62]]],
    lead: [[0, 72, 2], [6, 75, 2], [12, 79, 4], [20, 77, 2], [26, 75, 2]],
  },
  {
    id: 'lofi',
    name: 'LoFi Hip Hop 82',
    genre: 'LoFi',
    kit: 'boombap',
    bpm: 82,
    swing: 0.26,
    master: 'tape',
    drums: { kick: [0, 6, 10], snare: [4, 12], chat: [0, 2, 4, 6, 8, 10, 12, 14], rim: [14] },
    bass: [[0, 41], [6, 41], [8, 38], [12, 43]],
    chords: [[0, [53, 57, 60, 64]], [8, [55, 58, 62, 65]], [16, [50, 53, 57, 60]], [24, [48, 52, 55, 59]]],
    lead: [[0, 72, 4], [8, 74, 2], [12, 71, 4], [20, 69, 4]],
  },
  {
    id: 'afro',
    name: 'Afrobeats 105',
    ...
    bass: [[0, 36], [6, 36], [10, 41], [12, 43]],
    chords: [[0, [52, 55, 59]], [8, [50, 53, 57]], [16, [48, 52, 55]], [24, [50, 53, 57]]],
    lead: [[0, 76, 2], [4, 79, 2], [8, 76, 2], [12, 72, 4]],
  },
  {
    id: 'reggaeton',
    name: 'Reggaeton 96',
    ...
    bass: [[0, 33], [8, 33], [11, 36], [14, 31]],
    chords: [[0, [45, 48, 52]], [8, [43, 46, 50]], [16, [41, 45, 48]], [24, [43, 46, 50]]],
    lead: [[0, 69, 2], [6, 72, 2], [10, 76, 4]],
  },
  {
    id: 'amapiano',
    name: 'Amapiano 112',
    ...
    bass: [[0, 36], [6, 36], [7, 34], [8, 31], [14, 36]],
    chords: [[0, [48, 52, 55, 59]], [8, [53, 57, 60, 64]], [16, [50, 53, 57, 60]], [24, [45, 48, 52, 55]]],
    lead: [[0, 72, 2], [8, 76, 2], [16, 79, 2], [24, 74, 4]],
  },
  {
    id: 'synthwave',
    name: 'Synthwave 110',
    ...
    swing: 0,
    master: 'wide',
    drums: { kick: [0, 4, 8, 12], snare: [4, 12], chat: [2, 6, 10, 14], ohat: [7, 15], tomhi: [15] },
    bass: [[0, 33], [2, 45], [4, 33], [6, 45], [8, 31], [10, 43], [12, 31], [14, 43]],
    chords: [[0, [57, 60, 64]], [8, [55, 58, 62]], [16, [53, 57, 60]], [24, [55, 58, 62]]],
    lead: [[0, 76, 2], [2, 79, 2], [4, 81, 4], [8, 79, 2], [12, 76, 4], [20, 74, 4]],
  },
  {
    id: 'dubstep',
    name: 'Dubstep 140',
    ...
    master: 'club',
    bars: 2,
    drums: { kick: [0, 10, 16, 20], snare: [8, 24], chat: [4, 12, 20, 28], ohat: [15], cym: [0] },
    bass: [[0, 29], [4, 29], [8, 31], [12, 29], [16, 27], [24, 29]],
    chords: [[0, [53, 56, 60]], [16, [51, 55, 58]]],
    lead: [[0, 65, 4], [8, 68, 4], [16, 63, 8]],
  },
  {
    id: 'ambient',
    name: 'Ambient 70',
    ...
    swing: 0,
    master: 'wide',
    drums: { shaker: [0, 8], rim: [12], cym: [0] },
    bass: [[0, 36], [16, 34]],
    chords: [[0, [48, 55, 60, 64]], [16, [46, 53, 58, 62]]],
    lead: [[0, 72, 8], [16, 76, 8], [24, 79, 8]],
  },
];
...
export function createTemplate(id) {
  ...
  const mp = masterPreset(tpl.master || 'streaming');
  return {
    ...createEmptyProject(),
    name: tpl.name,
    bpm: tpl.bpm,
    ...
    master: {
      ...
      preset: mp.id,
      target: mp.target,
      chain: mp.chain.map((c) => ({ ...makeFx(c.type), params: { ...defaultFxParams(c.type), ...c.params } })),
    },
    channels,
    patterns,
    inserts,
